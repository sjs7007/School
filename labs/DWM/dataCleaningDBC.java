//Data Cleaning with DB Connectivity
...
class dataCleaningDBC
{
	public static void main(String args[]) throws ClassNotFoundException,SQLException
	{
		...
		*/
		...
		PreparedStatement statement = connect.prepareStatement("select * from dataCleaning");
		...
		while(rs.next())
		{
			...
			Students[i] = new Record(temp1,temp2,temp3);
			i++;
		}
